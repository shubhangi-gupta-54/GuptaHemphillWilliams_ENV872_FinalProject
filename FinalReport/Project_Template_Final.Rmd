...
```{r Energy Analysis, echo=FALSE, fig.height=5, fig.width=20, paged.print=FALSE}
...
## Plotting capacity and generation vs prices
...
```{r Plotting capacity and generation vs. prices, fig.height=6, fig.width=7}
#Capacity
